...
description: Project architecture and engineering guidelines for Flutter/Dart code. Follow when creating, modifying, refactoring, or reviewing feature code, state management with Riverpod, repository patterns, UI layouts, networking, navigation, and error handling.
---

# Flutter Architecture & Engineering Guidelines

Use this skill whenever creating, modifying, refactoring, or reviewing Flutter/Dart code in this repository.
